...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "geeft een array of lijst terug met elementen";
Blockly.Msg.LISTS_GET = "het element";
Blockly.Msg.LISTS_GET_INDEX_FROM_END = "# vanaf het einde";
Blockly.Msg.LISTS_GET_INDEX_FROM_START = "# vanaf het begin"; // untranslated
Blockly.Msg.LISTS_GET_INDEX_GET = "Ophalen";
Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE = "ophalen en verwijderen";
Blockly.Msg.LISTS_GET_INDEX_LAST = "laatste";
Blockly.Msg.LISTS_GET_INDEX_RANDOM = "willekeurig";
Blockly.Msg.LISTS_GET_INDEX_REMOVE = "verwijderen";
Blockly.Msg.LISTS_GET_INDEX_TAIL = "staart"; // untranslated
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "geeft het eerste item in een lijst terug";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM = "geeft het item terug op de gespecificeerde positie";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "geeft het laatste item terug";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "geeft een willekeurig item terug";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "Verwijdert en geeft het eerste item terug";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM = "Verwijdert en geeft het item terug op de gespecificeerte positie";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST = "Verwijdert en geeft het laatste item terug";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM = "Verwijdert en geeft een willekeurig item terug";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST = "Verwijdert het eerste item in een lijst";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM = "Verwijdert het item op de gespecificeerde positie in de lijst";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST = "Verwijdert het laatste item uit de lijst";
