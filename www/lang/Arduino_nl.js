...
Blockly.Msg.pin = "Pin";
Blockly.Msg._AT = "to";
Blockly.Msg.AV = "voorwaarts";
Blockly.Msg.AR = "achterwaards";
Blockly.Msg.high = "HIGH"; // do not translate
Blockly.Msg.low = "LOW"; // do not translate
Blockly.Msg.right = "rechts";
Blockly.Msg.left = "links";
Blockly.Msg.LetR = "rechts & links";
Blockly.Msg.direction = "richting";
Blockly.Msg.vitesse = "snelheid";
Blockly.Msg.values = "↺0-90 | ↻90-180";
Blockly.Msg.Name = "Naam";
// categories (menu)
Blockly.Msg.CAT_TAB = "🔠 Matrix";
Blockly.Msg.CAT_list = "🔤 Lijst";
Blockly.Msg.CAT_LOGIC = "🔂 Logica";
Blockly.Msg.CAT_MATH = "🔢 Rekenen";
Blockly.Msg.CAT_TEXT = "🔤 Tekst";
Blockly.Msg.CAT_VARIABLES = "🔀 Variabelen";
Blockly.Msg.CAT_FUNCTIONS = "🔣 Functies";
Blockly.Msg.CAT_ARDUINO = "🔄 Structuur";
Blockly.Msg.CAT_ARDUINO_IN = "🔛 Invoer / uitvoer";
Blockly.Msg.CAT_ARDUINO_OUT = "↪️ Uitvoer";
Blockly.Msg.CAT_ARDUINO_TIME = "⏱️ Tijd"; 
Blockly.Msg.CAT_OTTO = "🤖 Otto";
Blockly.Msg.CAT_OTTO_ARMS = "🦾 Armen";
Blockly.Msg.CAT_OTTO_WHEELS = "💿 Wielen";
Blockly.Msg.CAT_OTTO_NINJA = "🐱‍👤 Ninja";
Blockly.Msg.CAT_OTTO_QUAD = "🕷️ Quad";
Blockly.Msg.CAT_ARDUINO_matrice8x8 = "👄 LED Mond";
Blockly.Msg.CAT_ARDUINO_matrice16x8 = "👀 LED Ogen";
Blockly.Msg.CAT_ESCORNABOT="🐞 Escornabot";
Blockly.Msg.CAT_servo = "🦾 Servo";
Blockly.Msg.CAT_actionneur = "⚙️ Motor";
Blockly.Msg.CAT_ARDUINO_moteur="⚙️ Stappenmotor";
Blockly.Msg.CAT_ultrason = "📏 Afstandssensor";
Blockly.Msg.CAT_SENSORS = "👂 Sensoren";
Blockly.Msg.CAT_numerique = "0️⃣ Digitaal";
Blockly.Msg.CAT_analogique = "🔢 Analoog";
Blockly.Msg.CAT_GYRO = "⚖️ Gyroscoop";
Blockly.Msg.CAT_VIBRATE = "🖐️ Trilling";
Blockly.Msg.CAT_MAGNET= "🧲 Magnetisme";
Blockly.Msg.CAT_TEMP = "🌡️ Temperatuur"
Blockly.Msg.CAT_LIGHT = "🌞 Licht"
Blockly.Msg.CAT_WATER = "💧 Water"
Blockly.Msg.CAT_SOUND ="🎤 Geluid"
Blockly.Msg.CAT_HMC5883="🧭 Kompas";
Blockly.Msg.CAT_RFID="💳 RFID";
Blockly.Msg.CAT_KEYBOARD="🖱️Muis & ⌨️Toetsenbord";
Blockly.Msg.CAT_CCS811 = "⛅ CO₂";
Blockly.Msg.CAT_GAS = "⛽ Gas"
Blockly.Msg.CAT_RTC_DS3231 = "⏲️ Klok";
Blockly.Msg.CAT_TIME_GENERAL = "Algemeen";
Blockly.Msg.CAT_BME280 = "🗜️ Druk";
Blockly.Msg.CAT_VL53L0X = "📏 Afstand";
Blockly.Msg.CAT_APDS9960 = "👋 Gebaren";
Blockly.Msg.CAT_TCS34725 = "🌈 Kleur";
Blockly.Msg.CAT_Displays = "💻 Schermen";
Blockly.Msg.CAT_OLED_U8G = "🖥️ OLED";
Blockly.Msg.CAT_OLED_1 = "🖥️ OLED";
Blockly.Msg.CAT_TFT_ST7735 = "📺 TFT";
Blockly.Msg.CAT_del = "🔆 Grafisch";
...
Blockly.Msg.CAT_BARGRAPH = "💡 LED Balken";
Blockly.Msg.CAT_LCDI2C = "📟 LCD";
Blockly.Msg.CAT_BUZZER="🎼 Zoemer";
Blockly.Msg.CAT_AUDIO = "🔉 Geluid";
...
Blockly.Msg.CAT_com = "📡 Communicatie";
...
Blockly.Msg.CAT_RemoteIR = "🕹️ Afstandsbediening";
...
Blockly.Msg.RTCDS3231_RTC="⏲️ Datum en tijd instellen ";
Blockly.Msg.RTCDS3231_DAY="Dag";
Blockly.Msg.RTCDS3231_MONTH="Maand";
Blockly.Msg.RTCDS3231_YEAR="Jaar";
Blockly.Msg.RTCDS3231_HOUR="Uur";
Blockly.Msg.RTCDS3231_MINUTE="Minuut";
Blockly.Msg.RTCDS3231_SECOND="Seconde";
Blockly.Msg.RTCDS3231_DOFWEEK="Dag van de week";
Blockly.Msg.RTCDS3231_READ_RTC="⏲️ RTC Lees datum en tijd";
...
Blockly.Msg.times = [["seconden", "s"], ["milliseconden", "m"], ["microseconden", "u"]];
Blockly.Msg.time = [["seconden", "s"], ["milliseconden", "m"]];
...
Blockly.Msg.FIELDDROPDOWN = [["1 HOOG", Blockly.Msg.high], ["0 LAAG", Blockly.Msg.low]];
Blockly.Msg.FIELDDROPDOWN_0_1 = [["Omhoog", Blockly.Msg.high], ["Omlaag", Blockly.Msg.low]];
...
Blockly.Msg.FIELDDROPDOWN_ONOFF = [["aanzetten", Blockly.Msg.high], ["uitzetten", Blockly.Msg.low]];
...
Blockly.Msg.menudht = [["💧vochtigheid", "h"], ["🌡️temperatuur", "t"]];
...
Blockly.Msg.bp = "knop ingedrukt op Pin";
Blockly.Msg.bp_tooltip = "Geeft waar (niet waar) als een drukknop wel (of niet) ingedrukt is.";
...
Blockly.Msg.ultrason_distance1 = "afstand (cm)";
Blockly.Msg.ultrason_tooltip = "HC-SR04: \nUltrasone afstandssensor meet afstanden (tussen 3cm en 400cm)\ngeef de pinnummers van de pinnen voor Trig en Echo.";
Blockly.Msg.ultrason = "Afstandssensor Pins";
Blockly.Msg.ultrason_distance2 = "HC-SR04: \ngeeft de afstand in centimeters, die gemeten wordt door de sensor.";
Blockly.Msg.pir = "motion detected ";
Blockly.Msg.feu = "flame detected ";
Blockly.Msg.presence = "obstacle detected ";
Blockly.Msg.appui = "aanraaksensor ";
...
//LCD screen
Blockly.Msg.lcd_fond = "onderkant";
Blockly.Msg.LCD = "LCD scherm";
...
Blockly.Msg.LCD_SHIELD_PRINT_TEXT = "tonen";
Blockly.Msg.LCD_SHIELD_PRINT_TEXT_tooltip = "display the text in the specified location";
Blockly.Msg.LCD_SHIELD_PRINT_TOOLTIP = "schrijf tekst op het scherm";
...
Blockly.Msg.LCD_raz = "maak het scherm leeg";
Blockly.Msg.LCD_raz_tooltip = "scherm leegmaken 🧹";
Blockly.Msg.lcd_aff_symbole = "symbool tonen";
...
//time
Blockly.Msg.millis ="verstreken tijd in";
Blockly.Msg.millis_start="tijd bijhouden in";
...
Blockly.Msg.ARDUINO_BASE_DELAY = "⏲ wacht";
Blockly.Msg.ARDUINO_BASE_DELAY_TOOLTIP = "Specificeer de tijd in seconden, milliseconden of microseconden. \nHet programma doet niets in deze tijd.";
Blockly.Msg.millis1 = "tijdsduur in";
Blockly.Msg.millis2 = "vanaf het begin";
Blockly.Msg.ARDUINO_SINCE_PROGRAM_STARTED_TOOLTIP = "geeft de tijdsduur in milliseconden, seconden of microseconden sinds de start van het programma";
Blockly.Msg.ARDUINO_PULSEIN = "tijdsduur van deze staat";
...
Blockly.Msg.tempo1 = "elke";

// LED
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_INPUT = "💡 LED op het Arduino bord";
...
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT1 = "Write Analog PWM Pin";
...
Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_INPUT = "Read Analog value Pin ";
Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_TOOLTIP = "returns a value between 0 and 1023";
// audio
Blockly.Msg.play = "Speel";
Blockly.Msg.play_tooltip = "speel een noot";
Blockly.Msg.play_helpurl = "";
Blockly.Msg.beep = "🦗 piep op Pin";
Blockly.Msg.beep_TOOLTIP = "piept (op 440Hz voor 1s) op de geselecteerde Pin";
Blockly.Msg.ARDUINO_TONE_INPUT1 = "🎼 Zoemer Pin";
Blockly.Msg.ARDUINO_TONE_INPUT2 = "🎼 frequentie (Hz)";
Blockly.Msg.ARDUINO_TONE_INPUT3 = "⏰ tijdsduur (ms)";
Blockly.Msg.ARDUINO_TONE_TOOLTIP = "maak een geluid op de geselecteerde Pin, op de aangegeven op de frequentie en tijdsduur";
Blockly.Msg.ARDUINO_NOTONE_INPUT = "🛑 stop geluid op Pin";
Blockly.Msg.ARDUINO_NOTONE_TOOLTIP = "stop het geluid op de geselecteerde Pin";
Blockly.Msg.ARDUINO_RTTTL_BLOCK = "Speel een muziekje";
...
// servomotor
Blockly.Msg.ARDUINO_SERVO_MOVE_INPUT1 = "Draai Servo";
Blockly.Msg.ARDUINO_SERVO_MOVE_DEGREE = "hoek [0°-180°]";
Blockly.Msg.ARDUINO_SERVO_MOVE_TOOLTIP = "Mogelijke hoeken: tussen 0 en 180 graden.";
Blockly.Msg.ARDUINO_SERVO_ROT_CONTINUE_TEXT = "Draai wiel";
Blockly.Msg.ARDUINO_SERVO_ROT_CONTINUE_TOOLTIP = "Draai het wiel van de servo verbonden aan de aangegeven pin, op deze snelheid [0-90] en in de geselecteerde richting.";
//engine
...
Blockly.Msg.OTTO9_HOME_TOOLTIP = "Otto gaat naar de home positie (benen recht, voeten recht)";
Blockly.Msg.OTTO9_BUZZER="🎼 Zoemer";
Blockly.Msg.OTTO_HOME_TEXT = "Pinnen";
Blockly.Msg.OTTO9_DIY_URL = "https://www.ottodiy.com/academy";// do not translate
Blockly.Msg.OTTO9_CALIBRATION='Calibreren ';
Blockly.Msg.OTTO9_CALIBRATION_LEG='Been ';
Blockly.Msg.OTTO9_CALIBRATION_FOOT='Voet ';
...
Blockly.Msg.OTTO9_MOVE_TEXT = "Bewegen";
...
Blockly.Msg.OTTO9_MOVE_SPEED_TEXT = "Snelheid";
Blockly.Msg.OTTO9_MOVE_SPEED_CHOICE = [["normaal", "1000"],["langzaam", "2000"],["heel langzaam", "3000"] , ["snel", "750"], ["heel snel", "500"], ["veel te snel", "250"]];
Blockly.Msg.OTTO9_MOVEW_SPEED_CHOICE = [["normaal", "45"],["langzaam", "20"],["heel langzaam", "10"] , ["snel", "60"], ["heel snel", "90"]];
Blockly.Msg.OTTO9_DANCE_TEXT = "Dansen";
Blockly.Msg.OTTO9_DANCE_TOOLTIP = "Otto laten dansen!";
...
Blockly.Msg.OTTO9_DANCE_SIZE_TEXT = "Grootte";
Blockly.Msg.OTTO9_DANCE_SIZE_CHOICE = [["Normaal", "25"], ["Klein", "10"], ["Groot", "40"]];
Blockly.Msg.OTTO9_DO_TEXT = "Doen";
Blockly.Msg.OTTO9_DO_TOOLTIP = "Otto complexe bewegingen";
...
Blockly.Msg.OTTO9_MOUTH_TEXT = "Mond";
Blockly.Msg.OTTO9_MOUTH_TOOLTIP = "Mond emotie voor de 8x8 LED matrix #0-30";
Blockly.Msg.OTTO9_MOUTH_CHOICE = [["😃 blij1", "happyOpen"],["🙂 blij2", "happyClosed"], ["😊 glimlach", "smile"], ["😦 verdrietig1", "23"], ["🙁 verdrietig2", "24"], ["😮 verrast", "smallSurprise"], ["😲 verrast2", "bigSurprise"], ["😕 in de war", "confused"],["😛 tong", "tongueOut"],["🙃 ondersteboven", "culito"],  ["😑 serieus", "lineMouth"], ["🙄 ontdaan", "21"], ["💖 hart", "heart"], ["🦇 v1", "vamp1"], ["🦇 v2", "vamp2"], ["❌ nee", "xMouth"], ["✅ OK", "okMouth"],["❓?", "27"], ["⚡ bliksem", "thunder"]];
Blockly.Msg.OTTO9_MATRIX_TOOLTIP = "Pins: DIN A3, CS A2, CLK A1, Limited to CAPITALS A to Z NUMBERS 0 to 9 : ; < >  = @, max.9 characters";
Blockly.Msg.OTTO9_MATRIXTEXT_TEXT = "👄 Mond tekst";
...
Blockly.Msg.BUTTON_TOUCH_NAME="Aanraaksensor";
...
Blockly.Msg.SOUND_NAME="Geluidssensor";
...
Blockly.Msg.ultrasonic_ranger="Afstandssensor Pins";
...
Blockly.Msg.MP3OS_init = "Mp3 Opensmart Pins";
...
//OLED
Blockly.Msg.OLED_IconName = "Icoon ontwerp";
Blockly.Msg.OLED_ValueList = "Waarden(hex array)";
Blockly.Msg.OLED_DrawiconName = "Teken";
Blockly.Msg.OLED_X0 = "X0";
Blockly.Msg.OLED_Y0 = "Y0";
Blockly.Msg.OLED_width = "breedte";
Blockly.Msg.OLED_height = "hoogte";
Blockly.Msg.OLED_COLOR = "Stel kleur in op";
...
Blockly.Msg.MAX7219_LM_NAME="LED Matrix Pins";
...
Blockly.Msg.WifiServer_ESP8266webserver_port="Wifi ESP8266WebServer begin in port"
